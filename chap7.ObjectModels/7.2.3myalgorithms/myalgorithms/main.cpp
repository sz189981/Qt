...
int main(int argc, char *argv[])
{
    ...
    //add by sunzhong 20180710 for 通用算法
    QStringList list;
    list<<"one"<<"two"<<"three";
    ...
    //从list的开始到结束的所有项目与vect的开始及其后面的等数量项目进行比较
    //全部相同，则返回true
    ...
    qDebug()<<list;    //结果为eleven, eleven, eleven
    /**************************************************/
    QList <int> list1;
    list1<<3 <<3<<6<<6<<6<<8;
    ...
    qDebug()<<"pi:"<<pi<<"e:"<<e;   //结果为pi:2.71 e:3.14
